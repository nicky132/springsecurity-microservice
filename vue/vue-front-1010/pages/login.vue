  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      ...
      <div class="more-sign">
        <h6>社交帐号登录</h6>
        <ul>
          <li><a id="weixin" class="weixin" target="_self" href="http://localhost:8150/api/ucenter/wx/login"><i class="iconfont icon-weixin"/></a></li>
...
export default {
  ...
  methods: {
    loginUser(){ //用户登录
      ...
      loginApi.loginUser(this.user).then(res=>{
